...
```{r}
#All HTMLS in CoinATMRadar's Kansas City page were manually downloaded. Below is the Powershell command to rename the HTMLs from their site names to R-friendly file names
...
register_google(key="AIzaSyCPGtFAnjyBk2W7Fsb-_9bvVM1Qmn3Jqi8")
